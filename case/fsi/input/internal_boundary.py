...
class InternalBoundary(Group, Writable):
    def __init__(self, f):
        ...
        self._children.internalBoundaryPresent = Field(
            "internalBoundaryPresent", False, "", Field.vmapPresets.bool2int
        )
        self._children.iblankFastOptions = Field(
            "iblankFastOptions", "x", "", {"x": 1, "y": 2, "z": 3}
        )

        self._children.icc = Field("icc", False, "Cut Cell", Field.vmapPresets.bool2int)
        self._children.momentumCutCell = Field(
            "momentumCutCell", False, "", Field.vmapPresets.bool2int
        )
        ...
        self._children.boundaryFormulation = Field(
            "boundaryFormulation", "gcm", "", {"ssm": 1, "gcm": 2}
        )
