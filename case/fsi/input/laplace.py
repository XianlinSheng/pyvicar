...
class LaplaceSolver(Group, Writable):
    def __init__(self, f):
        ...
        self._children.VDVActive = Field('VDVActive', False, '', Field.vmapPresets.bool2int)
        ...
        self._children.idirection = Field('idirection', 'x', '', Field.vmapPresets.xyz2int)
        ...
        self._children.itSolverTypeLaplace = Field('itSolverTypeLaplace', 'mg', '', {'linesor': 1, 'mg': 2})
