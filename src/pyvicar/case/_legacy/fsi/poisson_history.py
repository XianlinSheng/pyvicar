...
class PoissonHistory(Group, Writable, Optional):
    ...
    def _init(self):
        ...
        self._children.nFrame = Field("nFrame", 0)
        self._children.frames = Field("frames", np.zeros((0, 1), dtype=int))
    ...
    def write(self):
        ...
        self._headerFormatter += self._children.nFrame
        self._headerFormatter.write()

        self._f.write("\n")

        self._arrayFormatter += self._children.frames
