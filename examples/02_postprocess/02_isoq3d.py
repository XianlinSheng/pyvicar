...
from pyvicar.tools.post.dump import gen_isoq_video, Color, Field, set_cam_compass
...
#           set_cam_compass(target, l0=..., r=..., oclock=..., downstream_shift=...)
#                       target: the position of object, if using GridModel, can be gm.center
#                       l0: the length scale of object, default 1
#                       r: distance between cam and target (radius of compass), default 3x l0
